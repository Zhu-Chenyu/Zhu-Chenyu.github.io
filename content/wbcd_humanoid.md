---
title: "双臂人形机器人货架拣选系统 · WBCD 2026 季军 · 最佳创意末端执行器奖"
title_en: "Bimanual Humanoid Shelf-Picking · WBCD 2026 2nd Place · Best Creative End-Effector Award"
date: 2026-07-05
draft: false
author: "Chenyu Zhu"
tags:
...
description: "在 WBCD 2026 赛事中，团队为 Unitree G1 人形机器人设计了非对称双夹爪系统与全身遥操作栈，荣获总成绩第二名及最佳创意末端执行器奖。"
toc: true
links:
  - icon: fas fa-trophy
    name: "Competition"
...
早期方案将手套内腔设计为 Dex1-1 手指的精确布尔减法负形，结果对打印公差极为敏感——轻微过挤出即导致无法套入。

最终方案改为**释放内腔 + 圆柱定位特征（销钉 + 贯通轴）**，仅在几个精确接触点约束位置，彻底消除公差敏感性，且手套更换只需数秒。
...
**反直觉但关键的设计逻辑：** 硬质物品用柔顺手套，软质物品用刚性裸手。软物易被压扁或挤出，刚性夹爪可精确控制夹持力；硬质圆物易从平夹爪滑落，弯曲柔顺指尖可形约束防滑。每种物品被分配到最能规避其失效模式的那只手。
...
**反面教训——腕部相机：** 尝试加装 Intel RealSense D405 腕部相机以获得近场深度信息，结果 G1 板载 CPU 无法承载额外负载，视频延迟从 100 ms 飙升至约 400 ms，整个遥操作管道变得不可用，最终移除。结论：每个额外传感器的成本应以 CPU 时间衡量，而非仅看重量与价格。
